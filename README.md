...
기존의 클래식 공연 정보는 인터파크, 예스24, 롯데콘서트홀 등 여러 예매 사이트에 흩어져 있어 한눈에 파악하기 어려웠습니다.

또한, "베토벤 교향곡 5번"이나 "쇼팽 피아노 협주곡"처럼 내가 듣고 싶은 '작품명'이나 '작곡가'를 중심으로 공연을 검색할 수 있는 기능이 없어, 원하는 공연을 찾는 데 많은 시간을 쏟아야 하는 불편함이 있었습니다.

classic-hub는 이러한 문제점을 해결하기 위해 시작되었습니다. 흩어져 있는 공연 정보를 한곳에 모으고, AI를 활용해 프로그램 정보를 정제하여 작품 및 작곡가 기반의 상세 검색을 제공함으로써, 사용자가 원하는 공연을 가장 빠르고 정확하게 찾을 수 있도록 돕는 것을 목표로 합니다.
