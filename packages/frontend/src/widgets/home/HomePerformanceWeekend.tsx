  ...
  return (
    <div className="mt-14 w-full">
      <div className="flex flex-col items-center gap-[1.31rem] mx-auto max-w-7xl">
        ...
        />
        <ul className="relative hidden min-[960px]:grid grid-cols-5 gap-[1.31rem] w-[calc(100%-3.5rem)]">
          ...
          <button className="absolute z-10 top-[50%] right-0 w-[3.25rem] h-[3.25rem] flex justify-center items-center border border-[rgba(0,0,0,0.1)] rounded-full bg-[rgba(255,255,255,0.9)] shadow-[0_0_8px_0_rgba(0, 0, 0, 0.13)] translate-y-[-50%] translate-x-[50%]">
            <img src={rightArrow} alt="" />
          </button>
        </ul>
        <ul className="hidden max-[960px]:flex flex-col gap-[0.88rem] w-[calc(100%-2rem)]">
          {performanceArray.map((performance) => (
