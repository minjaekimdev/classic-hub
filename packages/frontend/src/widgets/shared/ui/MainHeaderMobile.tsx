...
const MainHeaderMobile = () => {
  ...
  return (
    <h1 className="sticky z-(--z-header) top-0 flex justify-center items-center px-088 py-[0.49rem] bg-white">
      <Link to="/">
        <img src={logo} alt="로고" />
      </Link>
      ...
      <div className="flex-1">
        <div
          className="flex items-center justify-between rounded-full px-088 h-10 bg-[#F3F4F6] cursor-pointer"
