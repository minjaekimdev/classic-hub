  ...
  return (
    <div className="w-full border-t border-[rgba(0,0,0,0.1)] bg-[rgba(236,236,240,0.3)]">
      <div className="flex justify-between items-center mx-auto py-[1.81rem] px-7 max-w-7xl">
        ...
        <Modal.Trigger>
          <div className="shrink-0 flex justify-center items-center border border-[rgba(0,0,0,0.1)] rounded-button p-[0.36rem_0.4rem_0.27rem_0.61rem] bg-white text-dark text-[0.76rem]/[1.09rem] font-medium cursor-pointer hover:bg-[rgb(233,235,239)]">
